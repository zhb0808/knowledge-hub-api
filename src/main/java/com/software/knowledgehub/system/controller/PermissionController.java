...
public class PermissionController {
    ...
    @GetMapping
    public ApiResponse<Page<PermissionVO>> listPermissions(
            @Valid PermissionQueryDTO request,
            @SortDefault(
                    sort = "sortOrder",
                    direction = Sort.Direction.ASC
            ) Pageable pageable) {
        return ApiResponse.success(permissionService.listPermissions(request, pageable));
    }
